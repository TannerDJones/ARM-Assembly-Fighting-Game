...
INFINITY:
    ...
    MOVEMENT_AVATAR1:
    LDR R4, = 0xff200050 // push buttons
...
ATTACKRIGHT1:
    // Attack Right
    LDR R4, = 0xff200050
    LDR R7, [R4] // 0x00000040
    AND R7, #4 // above is val to display dash
    CMP R7, #4
    BNE END_ATTACK_RIGHT1
    LDR R9, = 0x00000040 // Load Dash Pattern
...
ATTACKLEFT2:
    ...
    BNE AV2_MISS_L      // If neither, miss
...
.type Fetch_Avatar_2_MOVES %function
Fetch_Avatar_2_MOVES:
	PUSH {R0, R1, R2, R3, LR}
